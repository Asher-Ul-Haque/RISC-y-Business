...
bool MouseUtilities::isMousePressedInRectangle(sf::Vector2f CENTER, sf::Vector2f SIZE, const sf::Event* EVENT)
{
...
bool MouseUtilities::isMousePressedInCircle(sf::Vector2f CENTER, float RADIUS, const sf::Event* EVENT)
{
